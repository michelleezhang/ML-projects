...
class ReluActivation:
    ...
    def backward(self, grad, lr=None):
        ...
        gradient_relu = grad * (self.input_ >= 0)
...
class FullyConnected:
    ...
    def backward(self, grad, lr=0.1):
        ...
        if self.regularizer is not None:
            ...
            # handle how regularization affects the gradient update.
            weights_copy = np.copy(self.weights)
            self.weights -= self.regularizer.grad(weights_copy) * lr
